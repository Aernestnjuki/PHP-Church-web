...
<body>
    ...
    <section class="admin-main-content">
        ...
        <div class="admin-mainbar">
            ...
            <div class="py-5">
                <h4 class="font-oswald text-center">Add Blogs</h4>
                <form action="addBlogs.php" method="post" enctype="multipart/form-data" class="font-poppins">
                    <!-- error messages -->
                    ...
                    <button type="submit" name="btnAddBlog" class="btn btn-info">Upload Blog</button>
                </form>
            </div>
        </div>
    </section>
