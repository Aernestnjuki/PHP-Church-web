...
<body>
    ...
    <section class="admin-main-content">
        ...
        <div class="admin-mainbar">
            ...
            <div class="py-5">
                <h4 class="font-oswald text-center">Manage Blogs</h4>
                <?php
                    ...
                    <tbody>
                        <?php foreach($blog_data as $key => $blog): ?>
                            <tr>
                                ...
                                <td><?php echo $blog['blogAuthor'] ?></td>
                                <td><a href="editBlogs.php?id=<?php echo $blog['id'] ?>" class="btn btn-success text-white">Edit</a></td>
                                <td><a href="index.php?delete_id=<?php echo $blog['id'] ?>" class="btn btn-danger text-white">Delete</a></td>
                                <?php if($blog['publish']): ?>
                                    <td><a href="index.php?publish=0&p_id=<?php echo $blog['id'] ?>" class="btn btn-warning text-white">Unpublish</a></td>
                                <?php else: ?>
                                    <td><a href="index.php?publish=1&p_id=<?php echo $blog['id'] ?>" class="btn btn-info text-white">Publish</a></td>
                                <?php endif; ?>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
