...
<body>
    ...
    <section class="admin-main-content">
        ...
        <div class="admin-mainbar">
            ...
            <div class="py-5">
                <h4 class="font-oswald text-center">Edit About</h4>
                <!-- error messages -->
                <?php include(ROOT_PATH . "/app/helpers/errorMessages.php") ?>
                <!-- error messages -->
                <form action="editAbout.php" method="post" enctype="multipart/form-data" class="font-poppins">
                    <div class="mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="about_rev" id="about-rev" class="form-control"><?php echo $about_rev ?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="about_church" id="about-church" class="form-control"><?php echo $about_church ?></textarea>
                    </div>
                    ...
                    <?php endif; ?>
                    <button type="submit" name="btnEditAbout" class="btn btn-info">Edit About</button>
                </form>
            </div>
        </div>
    </section>
