...
<body>
    ...
    <section class="admin-main-content">
        ...
        <div class="admin-mainbar">
            ...
            <div class="py-5">
                <h4 class="font-oswald text-center">Edit Events</h4>
                <form action="editEvents.php" method="post" enctype="multipart/form-data" class="font-poppins">
                    <!-- error messages -->
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="file" name="image" value="<?php echo $image ?>" id="image" placeholder="Choose am image for the Event" class="form-control">
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <button type="submit" name="btnEditEvent" class="btn btn-info">Edit Event</button>
                </form>
            </div>
        </div>
    </section>
