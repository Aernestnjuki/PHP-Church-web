...
<body>
    ...
    <section class="admin-main-content">
        ...
        <div class="admin-mainbar">
            ...
            <div class="py-5">
                <h4 class="font-oswald text-center">Edit Members</h4>
                <form action="editMembers.php" method="post" class="font-poppins">
                    <!-- error messages -->
                    ...
                    <button class="btn btn-info" name="editMember" type="submit">Edit member</button>
                </form>
            </div>
        </div>
    </section>
