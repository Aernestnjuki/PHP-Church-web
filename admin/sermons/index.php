...
<body>
    ...
    <section class="admin-main-content">
        ...
        <div class="admin-mainbar">
            ...
            <div class="py-5">
                <h4 class="font-oswald text-center">Manage Sermons</h4>
                <?php
                    ...
                    <tbody>
                        <?php foreach($sermon_data as $key => $sermon): ?>
                            <tr>
                                ...
                                <td><?php echo $sermon['sermon_name'] ?></td>
                                <td><?php echo $sermon['youtube_link'] ?></td>
                                <td><a href="editSermon.php?id=<?php echo $sermon['id'] ?>" class="btn btn-success text-white">Edit</a></td>
                                <td><a href="index.php?delete_id=<?php echo $sermon['id'] ?>" class="btn btn-danger text-white">Delete</a></td>
                                <?php if($sermon['publish']): ?>
                                    <td><a href="index.php?publish=0&p_id=<?php echo $sermon['id'] ?>" class="btn btn-warning text-white">Unpublish</a></td>
                                <?php else: ?>
                                    <td><a href="index.php?publish=1&p_id=<?php echo $sermon['id'] ?>" class="btn btn-info text-white">Publish</a></td>
                                <?php endif; ?>
                            </tr>
                        <?php endforeach; ?>
