...
<body>
    ...
    <section class="admin-main-content">
        ...
        <div class="admin-mainbar">
            ...
            <div class="py-5">
                <h4 class="font-oswald text-center">Add Sermons</h4>
                <form action="addSermons.php" method="post" class="font-poppins">
                    <!-- error messages -->
                    ...
                    <button type="submit" name="btnAddSermon" class="btn btn-info">Upload Sermon</button>
                </form>
            </div>
        </div>
    </section>
