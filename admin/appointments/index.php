...
<body>
    ...
    <section class="admin-main-content">
        ...
        <div class="admin-mainbar">
            ...
            <div class="py-5">
                <h4 class="font-oswald text-center">Manage Appointments</h4>
                <?php
                ...
                <table class="table pt-3 font-poppins">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Appointee date</th>
                            <th scope="col" colspan="2">Time & Date</th>
                            <th scope="col" colspan="2">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach($appointment_data as $key => $appoint): ?>
                            <tr>
                                <th scope="row"><?php echo $key + 1 ?></th>
                                <td><?php echo $appoint['appoint_email'] ?></td>
                                <td><?php echo $appoint['appoint_name'] ?></td>
                                <td><?php echo $appoint['appoint_county'] ?></td>
                                <td><?php echo $appoint['appoint_mobile'] ?></td>
                                <td><?php echo $appoint['appoint_date'] ?></td>
                                <td class="text-primary"><?php echo $appoint['meeting_date'] ?></td>
                                <td class="text-info"><?php echo $appoint['meeting_time'] ?></td>
                                <td><a href="editAppointments.php?id=<?php echo $appoint['id'] ?>" class="btn btn-success text-white">Set an Appointment</a></td>
                                <td><a href="index.php?delete_id=<?php echo $appoint['id'] ?>" class="btn btn-danger text-white">Delete</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
